...
from multiplication_viz_factor import (
    count_intersections,
...
class TestCandidateGeneration(unittest.TestCase):
    ...
    def test_candidates_near_sqrt(self):
        ...
        for candidate in candidates:
            ...
            self.assertLess(distance_ratio, 0.5, 
                          f"Candidate {candidate} too far from √N={sqrt_n}")
    ...
    def test_candidate_ordering(self):
        ...
        for candidate in candidates:
            ...
            self.assertGreaterEqual(dist, prev_dist - 1e-10,  # Allow floating point tolerance
...
class TestFactorValidation(unittest.TestCase):
    ...
    def test_alignment_small_semiprimes(self):
        ...
        self.assertGreaterEqual(alignment_rate, 0.95,
                              f"Alignment rate {alignment_rate:.2%} < 95%")
    ...
    def test_alignment_medium_semiprimes(self):
        ...
        self.assertGreaterEqual(alignment_rate, 0.5,
                              f"Alignment rate {alignment_rate:.2%} too low")
