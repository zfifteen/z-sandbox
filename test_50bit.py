#!/usr/bin/env python3
"""
Test script for advancing geometric factorization research to 50-bit unbalanced semiprimes.
"""
...
if __name__ == "__main__":
    # Use the small prime from the 40-bit example
    small_prime = 1031  # Known prime
    large_bits = 40  # For 50-bit total (10 + 40)
    seed = 42  # Fixed seed for reproducibility

    print("Generating 50-bit unbalanced semiprime...")
    ...
    # Test factorization
    stages = [(5, 0.05), (10, 0.002), (15, 0.0001), (20, 0.00005)]  # Extended stages
    print("\nTesting multi-stage geometric factorization...")
