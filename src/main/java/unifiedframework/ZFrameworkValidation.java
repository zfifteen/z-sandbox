...
public class ZFrameworkValidation {
    ...
    public static void validate(double k, double epsilon) {
        ...
        System.out.println("Shared manifold strongly supported by low effect sizes, high p-values, and small distances.");
    }
    ...
    public static void kSweep(double epsilon) {
        ...
        for (double k : ks) {
            ...
            double stdPool = Math.sqrt((std(zetaThetas) * std(zetaThetas) + std(primeThetas) * std(primeThetas)) / 2);
