 ...
 * Embeds a number into a high-dimensional torus using iterative transformations.
 */
public class Embedding {

    private static final BigDecimal PHI = new BigDecimal("1.61803398874989484820458683436563811772030917980576286213544862270526046281890244970720720418939113748475");
    private static final BigDecimal E_SQUARED = new BigDecimal("7.38905609893065022723042746057500781318031557055184732408712782252257379607905776338431248507912179586499");
    ...
    private BigDecimal pow(BigDecimal base, double exponent) {
        // Simple power using double for approximation; for high precision, could use BigDecimal exp/log but this suffices for now
