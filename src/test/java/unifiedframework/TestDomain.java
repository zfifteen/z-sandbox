...
public class TestDomain {
  ...
  public void testGetters() {
    ...
    System.out.printf("getD(): expected=%.20f, actual=%.20f, diff=%.2e%n", expectedD, actualD, Math.abs(expectedD - actualD));
  ...
  private void assertRelativeEquals(double expected, double actual, double relTol) {
    ...
    assertTrue(relError <= relTol, 
      String.format("Relative error too large: expected=%.20f, actual=%.20f, relError=%.2e, relTol=%.2e", 
