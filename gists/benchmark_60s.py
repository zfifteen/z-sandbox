...
def test_bit_size(bit_size, num_tests=5, max_time=60.0):
...
def find_max_bit_size(start_bit=28, max_time=60.0):
    """Find the highest bit size with >0% success in max_time seconds."""
    print("BENCHMARK: Finding highest bit size factorable in ≤60 seconds")
    print("="*70)
